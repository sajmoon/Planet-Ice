...
public class Game implements Runnable {
	...
	/*
	 * Do some nice commands? T ex use knife cut dude.. första är ett "action
	 * ord. Use, move, etc
	 */
	...
	public void run() {
		while (running) {
			try {
				...
				// här rör vi alla object, t ex om vi ska ha motståndarde så kan
				// de röras här. dvs efter varje sleep så
				// gör dom sitt move.
				// Sound.playScream(); //kanske dumt att ha ljud på servern. men
				// men ;D
